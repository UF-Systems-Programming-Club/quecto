...
void analyze_declaration(AnalysisContext *context, AST *assignment);
void analyze_assignment(AnalysisContext *context, AST *assignment);
void analyze_if(AnalysisContext *context, AST *decl);
void analyze_while(AnalysisContext *context, AST *decl);
void analyze_elif(AnalysisContext *context, AST *decl);
void analyze_else(AnalysisContext *context, AST *decl);
